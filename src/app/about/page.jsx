  ...
  return (
    <>
        <div className="max-w-6xl mx-auto p-3 space-y-4" style={{ textAlign: 'justify' }}>
            ...
            <p>
                Welcome to our movie/TV series database site!
            </p>
            <p>
                Our site is designed to offer a comprehensive database of movies and tv series from around the world.
                Our movie/TV series database is constantly updated with new releases, so you can access the latest and greatest productions in the cinema and tv world.
                You can search for movies/TV series by title, director, or actor/actress, making it easy to find the perfect movie/TV series for any occasion.
            </p>
            <p>
                Thank you for visiting our site, and we hope you have an enjoyable time browsing our movie/TV series database.
