...
export default function PersonPageCard({result, genre}) {
  ...
  return (
    <div className="group cursor-pointer shadow-lg rounded-lg m-6 sm:m-6 md:m-4 lg:m-2 mb-14 transition-transform transform duration-200 hover:scale-105 hover:bg-gray-100 hover:dark:bg-zinc-800">
