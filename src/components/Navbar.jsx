          ...
          <Suspense fallback={<div>Loading...</div>}>
            <Popover>
              ...
              >
                <PopoverPanel
                  anchor="bottom"
                  className="rounded-xl dark:bg-slate-600 bg-yellow-200 text-sm"
                >
                  <div className="p-3">
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchTrending">
                    ...
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchTrendingPerson">
            ...
            <Popover>
              ...
              >
                ...
                >
                  <div className="p-3">
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchTopRatedMovie">
                    ...
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchTopRatedTvSeries">
            ...
            <Popover>
              ...
              >
                ...
                >
                  <div className="p-3">
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchUpcomingMovie">
                      <p className="font-semibold dark:text-yellow-500 text-gray-800">Movies</p>
                      <p className="text-gray-400 dark:text-gray-200">Upcoming movies</p>
                    </a>
                    <a className="block rounded-lg py-2 px-3 transition dark:hover:bg-slate-700 hover:bg-yellow-400" href="/?genre=fetchUpcomingTvSeries">
                      <p className="font-semibold dark:text-yellow-500 text-gray-800">Tv Series & Shows</p>
